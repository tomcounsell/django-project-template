...
class FormValidationMixin:
    ...
    def get_error_dict(self) -> Dict[str, List[str]]:
        ...
        if '__all__' in self.errors:
            error_dict['non_field_errors'] = [str(error) for error in self.errors['__all__']]
    ...
    def raise_validation_error(self, message: str, code: str = 'invalid_form') -> None:
        ...
        raise ValidationError(
            message=message, 
            code=code, 
            field_errors=self.get_error_dict()
        )
...
def validate_form_data(form_class: Type[forms.Form], data: Dict[str, Any], 
                       request: Optional[HttpRequest] = None,
                       instance: Any = None) -> Tuple[Any, Dict[str, Any]]:
    """
