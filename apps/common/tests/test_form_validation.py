...
from apps.common.utilities.forms import BaseModelForm, FormValidationMixin, clean_form_data
...
class BlogPostFormTestCase(TestCase):
    ...
    def test_content_length_validation(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertIn('Content must be at least 100 characters long', form.errors['content'])
    ...
    def test_subtitle_validation(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertIn('Subtitle should be shorter than the title', form.errors['subtitle'])
    ...
    def test_reading_time_calculation(self):
        ...
        self.assertEqual(updated_instance.reading_time_minutes, 3)  # 2500 chars / 1000 = 2.5 → 3 (rounded up)