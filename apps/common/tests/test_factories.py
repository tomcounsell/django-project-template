...
from apps.common.tests.factories import (
    AddressFactory, CountryFactory, CurrencyFactory, DocumentFactory,
    ImageFactory, NoteFactory, UploadFactory, UserFactory
)

from apps.common.tests.factories import (
    BlogPostFactory, CityFactory, EmailFactory, SMSFactory,
...
class ExistingFactoriesTestCase(TestCase):
    ...
    def test_note_factory(self):
        ...
        user = UserFactory.create()
        custom_note = NoteFactory.create(
...
class CityFactoryTestCase(TestCase):
    ...
    def test_city_factory(self):
        ...
        custom_city = CityFactory.create(
            name='Tokyo',
            code='TYO',
            country=country
        )
...
class TeamMemberFactoryTestCase(TestCase):
    ...
    def test_team_member_factory(self):
        ...
        team = TeamFactory.create()
        user = UserFactory.create()
        custom_member = TeamMemberFactory.create(
            team=team,
            user=user,
            role='ADMIN'
        )
