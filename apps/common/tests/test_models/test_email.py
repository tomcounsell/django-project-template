...
class EmailModelTestCase(TestCase):
    ...
    @patch('apps.common.models.email.EmailMessage')
    def test_send_with_confirmation(self, mock_email_message, mock_send_later, mock_send_now):
    ...
    @patch('apps.common.models.email.Email.send_later')
    @patch('apps.common.models.email.EmailMessage')
    def test_send_without_confirmation(self, mock_email_message, mock_send_later, mock_send_now):
