...
class UploadModelTestCase(TimestampableTest, TestCase):
    ...
    def test_dimensions_property(self):
        ...
        with mock.patch.object(Upload, 'is_image', new_callable=mock.PropertyMock) as mock_is_image:
            ...
            with mock.patch.object(Upload, 'is_video', new_callable=mock.PropertyMock) as mock_is_video:
    ...
    @override_settings(AWS_ACCESS_KEY_ID="test", AWS_SECRET_ACCESS_KEY="test", AWS_S3_BUCKET_NAME="test")
    ...
    def test_save_method(self):
        ...
        self.assertEqual(
            upload.original,
            "https://test-bucket.s3.amazonaws.com/uploads/new-file.txt"
        )
