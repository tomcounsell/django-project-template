...
class AIChagentUnitTestCase(TestCase):
    ...
    @patch('apps.ai.agent.chat.chat_agent.run')
    async def test_process_chat_message_async(self, mock_run):
        """Test the async process_chat_message function."""
        from apps.ai.agent.chat import ChatDependencies, process_chat_message
