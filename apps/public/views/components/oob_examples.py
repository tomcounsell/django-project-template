...
class UpdateNavExample(HTMXView):
    ...
    def get(self, request: HttpRequest, *args, **kwargs) -> HttpResponse:
        ...
        return HttpResponse(f"<div>Navigation updated to: <strong>{section}</strong></div>")
...
class CombinedExample(HTMXView):
    ...
    def get(self, request: HttpRequest, *args, **kwargs) -> HttpResponse:
        ...
        return HttpResponse("<div class='p-4 bg-green-50 rounded-md'>Multiple OOB elements updated</div>")
