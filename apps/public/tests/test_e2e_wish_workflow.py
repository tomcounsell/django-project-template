...
class TestWishWorkflow(LiveServerTestCase):
    ...
    def test_create_wish_workflow(self):
        ...
        self.page.fill("textarea[name='description']", "This is a test wish created by E2E test")
        ...
        complete_button = self.page.locator("tr:has-text('Test Wish E2E') button:has-text('Done')")
