...
class S3ClientTestCase(TestCase):
    ...
    def test_upload_file(self):
        ...
        try:
            ...
            self.assertEqual(result["url"], "https://test-bucket.s3.amazonaws.com/test/file.txt")
    ...
    def test_upload_fileobj(self):
        ...
        result = self.client.upload_fileobj(
            file_obj=file_obj,
            object_key="test/fileobj.txt"
        )
        
        # Check result
        self.assertTrue(result["success"])
        self.assertEqual(result["url"], "https://test-bucket.s3.amazonaws.com/test/fileobj.txt")
    ...
    def test_generate_presigned_url(self):
        ...
        self.mock_s3_client.generate_presigned_url.return_value = "https://test-bucket.s3.amazonaws.com/test/file.txt?AWSAccessKeyId=..."
        ...
        self.assertTrue(result["url"].startswith("https://test-bucket.s3.amazonaws.com/test/file.txt"))
    ...
    def test_generate_presigned_post(self):
        ...
        self.assertEqual(result["file_url"], "https://test-bucket.s3.amazonaws.com/test/file.txt")
        ...
        self.mock_s3_client.generate_presigned_post.side_effect = Exception("Test error")
...
class UtilityFunctionsTestCase(TestCase):
    ...
    def test_get_file_upload_presigned_post(self, mock_s3_client_cls):
        ...
        with patch('apps.integration.aws.s3.generate_unique_filename') as mock_generate:
            ...
            self.assertIn(["content-length-range", 1, 10485760], call_args["conditions"])