...
class S3Client:
    ...
    def __init__(
        ...
        self.bucket_name = aws_s3_bucket_name or getattr(settings, 'AWS_S3_BUCKET_NAME', "")
        self.region_name = region_name or getattr(settings, 'AWS_REGION', 'us-east-1')
        self.enabled = bool(self.aws_access_key_id and self.aws_secret_access_key and self.bucket_name)
