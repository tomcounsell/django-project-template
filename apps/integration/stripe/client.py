    ...
    def create_checkout_session(
        ...
        **kwargs
        ...
        if settings.DEBUG or not self.enabled:
            ...
            logger.info(f"[DEBUG/DISABLED] Would create Stripe checkout session: {price_id}")
        ...
        if not self._validate_client():
            return {
                "success": False,
                "error": "Stripe client not properly configured"
            }
    ...
    def create_subscription(
        ...
        **kwargs
        ...
        if settings.DEBUG or not self.enabled:
            ...
            logger.info(f"[DEBUG/DISABLED] Would create Stripe subscription: {price_id}")
    ...
    def cancel_subscription(
        ...
        **kwargs
        ...
        if settings.DEBUG or not self.enabled:
            ...
            logger.info(f"[DEBUG/DISABLED] Would cancel Stripe subscription: {subscription_id}")
    ...
    def verify_webhook_signature(
        ...
        if settings.DEBUG or not self.enabled:
            ...
            try:
                ...
                logger.info(f"[DEBUG/DISABLED] Would verify Stripe webhook: {event_type}")
                # For DEBUG usage and testing
