...
class StripeClientLiveTestCase(TestCase):
    ...
    def test_create_checkout_session_success(self):
        ...
        mock_session.get.side_effect = lambda k, d=None: {"payment_intent": "pi_test123", "client_secret": "cs_secret_test123"}.get(k, d)
        ...
        self.assertEqual(result["session"]["url"], "https://checkout.stripe.com/pay/cs_test123")
    ...
    def test_verify_webhook_signature_success(self):
        ...
        self.mock_stripe.Webhook.construct_event.assert_called_once_with(
            ...
            secret=self.client.webhook_secret
        )
        
    def test_verify_webhook_signature_invalid(self):
        """Test verify_webhook_signature with invalid signature."""
        # Mock Stripe error
        signature_error = self.mock_stripe.error.SignatureVerificationError("Invalid signature")
